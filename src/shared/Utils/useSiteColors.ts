...
type SiteColors = {
  ...
  utils: {
    ...
    getCardStyle: () => { backgroundColor: string; borderColor: string; boxShadow: string };
    getButtonStyle: (variant?: 'primary' | 'secondary' | 'success' | 'warning' | 'danger' | 'info') => { backgroundColor: string; color: string; borderColor: string; boxShadow: string };
  };
};
...
export const useSiteColors = (): SiteColors => {
  ...
  return {
    ...
    utils: {
      ...
      getButtonStyle: (variant: 'primary' | 'secondary' | 'success' | 'warning' | 'danger' | 'info' = 'primary') => ({
