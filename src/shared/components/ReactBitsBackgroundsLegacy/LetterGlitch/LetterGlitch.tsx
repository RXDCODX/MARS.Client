...
const LetterGlitch = ({
  ...
  const lettersAndSymbols = [...characters];
  ...
  useEffect(() => {
    ...
    const handleResize = () => {
      ...
      resizeTimeout = setTimeout(() => {
        cancelAnimationFrame(animationReference.current as number);
        resizeCanvas();
        animate();
      }, 100);
    };
