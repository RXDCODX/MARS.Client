 ...
 */
export const StorybookMockPanel = React.memo(function StorybookMockPanel({
  hubName,
  mockMode = false,
  onEmitScenario,
  className,
  ...
  useEffect(() => {
    ...
    const eventScenarios = mockScenarioRegistry.getScenarios(hubName, selectedEvent);
    setScenarios(
  ...
  if (events.length === 0) {
    return (
      <div className={`${styles.mockPanel} ${styles.empty} ${className || ''}`}>
