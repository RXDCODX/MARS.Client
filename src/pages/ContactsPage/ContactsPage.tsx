        ...
        <div className={styles.container}>
          <div className={styles.contactContent}>
            ...
            <div className={styles.contactInfo}>
              <h2>Наши контакты</h2>
              <p>
                Выберите наиболее удобный для вас способ связи. Мы постараемся ответить 
                в кратчайшие сроки.
              </p>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.faqGrid}>
            <div className={styles.faqItem}>
              ...
              <p>
                Скачайте приложение, создайте аккаунт и следуйте инструкциям по настройке. 
                Наша документация поможет вам быстро освоить все функции.
              </p>
            </div>
            ...
            <div className={styles.faqItem}>
              ...
              <p>
                Да, MARS Client работает на всех современных устройствах, включая смартфоны 
                и планшеты.
              </p>
            </div>
            ...
            <div className={styles.faqItem}>
              ...
              <p>
                Да, мы предлагаем бесплатный план с базовыми функциями. Для расширенных 
                возможностей доступны платные подписки.
              </p>
            </div>
            ...
            <div className={styles.faqItem}>
              ...
              <p>
                Вы можете обратиться к нам через форму выше, Discord сервер или email. 
