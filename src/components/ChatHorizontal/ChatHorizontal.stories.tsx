...
const meta: Meta<typeof ChatHorizontal> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Горизонтальный чат с анимированными сообщениями, которые проходят через экран.',
      },
    },
  },
  tags: ['autodocs'],
...
export const Default: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const initialMessages = canvasElement.querySelectorAll('[class*="message"]');
    ...
    const allMessages = canvasElement.querySelectorAll('[class*="message"], [class*="container"]');
