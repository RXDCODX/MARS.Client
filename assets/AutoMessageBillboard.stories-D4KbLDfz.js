import{r as e,j as r}from"./iframe-BjL-cKrh.js";import{A as j}from"./Announce-D3c2WgwG.js";import{v as w,S as C}from"./index-YtfadmvT.js";import{u as S,r as F}from"./index-3u8u-C0z.js";import{m as I,A as L}from"./proxy-CsCd9JJB.js";import"./preload-helper-D9Z9MdNV.js";import"./index-D-P6gtBR.js";import"./index-Chjiymov.js";import"./index-D5MxPxIl.js";import"./react-DeaJAqDd.js";const T=[["#667eea","#764ba2"],["#f093fb","#f5576c"],["#4facfe","#00f2fe"],["#43e97b","#38f9d7"],["#fa709a","#fee140"],["#a8edea","#fed6e3"],["#ff9a9e","#fecfef"],["#ffecd2","#fcb69f"],["#ff9a9e","#fad0c4"],["#a18cd1","#fbc2eb"],["#fad0c4","#ffd1ff"],["#ffecd2","#fcb69f"],["#ff9a9e","#fecfef"],["#a8edea","#fed6e3"],["#d299c2","#fef9d7"]];function k({message:t,onComplete:m}){const o=e.useRef(null),a=S(s=>s.parser),p=S(s=>s.parseToLink),h=e.useMemo(()=>{const s=Math.floor(Math.random()*T.length),[i,c]=T[s];return`linear-gradient(135deg, ${i} 0%, ${c} 100%)`},[]);e.useEffect(()=>(o.current=setTimeout(()=>{m()},8e3),()=>{o.current&&clearTimeout(o.current)}),[m]);const b=a&&p?F({text:t,parser:a,newParser:p}):t;return r.jsx(I.div,{initial:{x:400,opacity:0},animate:{x:0,opacity:1,boxShadow:["0 10px 30px rgba(0, 0, 0, 0.3)","0 15px 40px rgba(255, 255, 255, 0.4)","0 20px 50px rgba(0, 0, 0, 0.2)","0 15px 40px rgba(255, 255, 255, 0.4)","0 10px 30px rgba(0, 0, 0, 0.3)"]},exit:{x:400,opacity:0,scale:.8},transition:{type:"spring",stiffness:100,damping:20,duration:.5,boxShadow:{duration:1.5,repeat:1/0,ease:"easeInOut"}},style:{position:"absolute",top:"50%",right:"20px",transform:"translateY(-50%)",width:"350px",background:h,borderRadius:"15px",padding:"20px",color:"white",fontFamily:'"Segoe UI", Tahoma, Geneva, Verdana, sans-serif',fontWeight:600,fontSize:"16px",lineHeight:1.4,textAlign:"center",border:"2px solid rgba(255, 255, 255, 0.2)",overflow:"visible",whiteSpace:"break-spaces",zIndex:1e3},children:r.jsxs("div",{style:{wordWrap:"break-word",hyphens:"auto",textShadow:"2px 2px 4px rgba(0, 0, 0, 0.5), 0 0 10px rgba(0, 0, 0, 0.3), 0 0 20px rgba(0, 0, 0, 0.2)",margin:0,padding:0,fontWeight:700},children:[b,r.jsx("style",{children:`
          .emote {
...
}`,...x.parameters?.docs?.source}}};const U=["Default","WithMockMessages","WithEmotes","LongMessages","SignalRMode"];export{u as Default,g as LongMessages,x as SignalRMode,f as WithEmotes,l as WithMockMessages,U as __namedExportsOrder,N as default};
