import{r as u,j as n}from"./iframe-rOG4V-f_.js";import{l as T}from"./index-BHbUthkP.js";import{m as d,A as S}from"./proxy-C_YSPh5Z.js";function w({children:t,colors:a=["#ee7752","#e73c7e","#23a6d5","#23d5ab"],duration:e=15,gradientAngle:s=-45}){u.useEffect(()=>{const i=document.createElement("style");return i.textContent=`
      @keyframes gradient {
        0% {
...
}`,...f.parameters?.docs?.source}}};const V=["Default","WithoutAnimation","WithoutCover","MultipleArtists"];export{v as Default,f as MultipleArtists,h as WithoutAnimation,y as WithoutCover,V as __namedExportsOrder,G as default};
