...
}`,...(h=(y=l.parameters)==null?void 0:y.docs)==null?void 0:h.source}}};var A,B,T;v.parameters={...v.parameters,docs:{...(A=v.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: () => {
    const [isActive, setIsActive] = useState(false);
    return <TestWrapper onActivate={() => setIsActive(true)}>\r
...
}`,...(T=(B=v.parameters)==null?void 0:B.docs)==null?void 0:T.source}}};var C,g,x;u.parameters={...u.parameters,docs:{...(C=u.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: () => {
    const [isActive, setIsActive] = useState(false);
    return <TestWrapper onActivate={() => setIsActive(true)}>\r
...
}`,...(x=(g=u.parameters)==null?void 0:g.docs)==null?void 0:x.source}}};const _=["ConfettyEffect","FireworkEffect","EmojiParticlesEffect"];export{l as ConfettyEffect,u as EmojiParticlesEffect,v as FireworkEffect,_ as __namedExportsOrder,R as default};
